...
class User {
	...
	public function removeFriend($user_to_remove) {
		...
		// Remove this user ($user_to_remove) from the $logged_in_user's friend array
	...
	public function getMutualFriends($user_to_check) {
		...
		// $user_array_explode = an array full of usernames
		// that's the friend array for the $userLoggedIn
		$user_array_explode = explode(",", $user_array); // Splits a string to an array at the given character

		// Get the friend array for the $user_to_check

		$query = mysqli_query($this->con, "SELECT friend_array FROM users WHERE username='$user_to_check'");
		$row = mysqli_fetch_array($query);
		$user_to_check_array = $row['friend_array'];
		$user_to_check_array_explode = explode(",", $user_to_check_array);
		// Now we have two variables containing the friend array for each user
