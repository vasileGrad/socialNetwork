...
// Handle the form
if(isset($_POST['register_button'])){ // if the button is pressed start than start handle the form
	// Registration form values

	//First name
	$fname= strip_tags($_POST['reg_fname']); // strip_tags - removes the tags HTML and PHP from a string
	...
	if($password != $password2){
		...
		// Checks the password to see that only contains letters or numbers
